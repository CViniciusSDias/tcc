...
![Splash Screen](imagens/01-splash.jpg){#tela-splash largura=100%}
...
![Cadastro dos Dados de Acesso](imagens/06-pergunta-secreta.jpg)(#tela-pergunta largura=100%)

Fonte: Aplicativo _Esqueci a Senha!_.

Digitando os dados e clicando em "Salvar", o usuário é conduzido para a página de login. Ver \autoref(tela-login).

![Login](imagens/08-login.jpg){#tela-login largura=100%}
...
![Home sem senhas](imagens/09-home.jpg){#tela-sem-senhas largura=100%}

Fonte: Aplicativo _Esqueci a Senha!_.

![Adicionar nova senha](imagens/11-adicionar.jpg){#tela-nova-senha largura=100%}

Fonte: Aplicativo _Esqueci a Senha!_.

![Home com uma senha](imagens/13-home.jpg){#tela-senhas largura=100%}
...
![Ações com a senha](imagens/14-action-sheet.jpg){#tela-action-sheet largura=100%}
